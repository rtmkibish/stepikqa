...
class BasePage:
  ...
  def is_disapeared(self, how, what, timeout=4):
    try:
  ...
  def should_be_authorized_user(self):
    assert self.is_element_present(*BasePageLocators.USER_ACCOUNT), 'User account is not presented, probably unauthorised user'
